...
export const getLedgers: ZoltraHandler = async (req, res, next) => {
  try {
...
export const getLedgerByAddress: ZoltraHandler = async (req, res, next) => {
...
export const getLedgerById: ZoltraHandler = async (req, res, next) => {
  const { id } = req.params;
  try {
...
export const getLedgerByTransactionId: ZoltraHandler = async (
  req,
  res,
  next
) => {
