...
export const transferToken: ZoltraHandler = async (req, res, next) => {
...
export const getTransactions: ZoltraHandler = async (req, res, next) => {
  try {
...
export const getUserTransactions: ZoltraHandler = async (req, res, next) => {
...
export const getTransaction: ZoltraHandler = async (req, res, next) => {
  const { id } = req.params;
  try {
    const user = req.user;
